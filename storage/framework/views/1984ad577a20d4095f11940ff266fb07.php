            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('profesores.createcomentario')); ?>">Realizar comentario</a></li>
                    </ul>
                </div>
                <?php if(Route::has('login')): ?>
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Inicio</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" style="margin-right: 2px; text-decoration:none" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Iniciar Sesion</a>

                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" style="text-decoration: none" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Registrar</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\CrudC-crea\resources\views/plantillainicio/inicio.blade.php ENDPATH**/ ?>