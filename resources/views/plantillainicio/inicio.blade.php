    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a href="{{ url('/') }}" class="navbar-brand" href="#page-top">C-Crea</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="#about" style="color: darkgray">Sobre Nosotros</a></li>
                        <li class="nav-item"><a class="nav-link" href="#projects" style="color: darkgray">Ofrecemos</a></li>
                        <li class="nav-item"><a class="nav-link" href="#politica" style="color: darkgray">Nuestra Política</a></li>
                        <li class="nav-item"><a class="nav-link" href="#signup" style="color: darkgray">Contáctenos</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('profesores.createcomentario') }}" style="color: darkgray">Realizar comentario</a></li>
                    </ul>
                </div>
                @if (Route::has('login'))
